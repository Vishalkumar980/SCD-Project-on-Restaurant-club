 ...
 <div id="contact" class="container-fluid bg-dark text-light border-top wow fadeIn">
        <div class="row">
            ...
            <div class="col-md-6 px-5 has-height-lg middle-items">
                ...
                <div class="text-muted">
                    <p><span class="ti-location-pin pr-3"></span> clifton civillines karachi sindh</p>
                    <p><span class="ti-support pr-3"></span> (03177124118)</p>
                    <p><span class="ti-email pr-3"></span>bcsbs2212203@szabist.pk</p>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="container-fluid bg-dark text-light has-height-md middle-items border-top text-center wow fadeIn">
        <div class="row">
            <div class="col-sm-4">
                <h3>EMAIL US</h3>
                <P class="text-muted">bcsbs2212203@szabist.pk</P>
            </div>
            <div class="col-sm-4">
                <h3>CALL US</h3>
                <P class="text-muted">(03177124118)</P>
            </div>
            <div class="col-sm-4">
                <h3>FIND US</h3>
                <P class="text-muted">karachi sindh civillines</P>
            </div>
        </div>
    </div>
